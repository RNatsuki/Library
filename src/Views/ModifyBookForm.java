...
public class ModifyBookForm extends javax.swing.JFrame {
    ...
    public ModifyBookForm(int id, String title, int year, String author, String category, int edition, String language) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.book_id.setText(String.valueOf(id));
        this.book_title.setText(title);
        this.book_year.setText(String.valueOf(year));
        this.book_author.setText(author);
